"""
@Time ： 2023/1/20 19:33
@Auth ： Web3inFlare
@File ：query_testnet_arbitrum_nova.py
@IDE ：PyCharm
@Motto: 咕咕嘎嘎
"""
...
def payload_info():
    result = {
        'Name': 'query_testnet_arbitrum_nova',
        'Author': 'web3inflare',
        'Type': 'query',
        'CreateDate': '2023-1-20',
        'UpdateDate': '2023-1-27',
        'Network': "testnet",
        'Description': "query arbitrumnova balance",
        'Description_cn': "查询 arbitrumnova 余额",
    }
    return result
