"""
@Time ： 2023/1/24 23:19
@Auth ： Web3inFlare
@File ：TwitterFrontendFlow.py
@IDE ：PyCharm
@Motto: 咕咕嘎嘎
"""
...
class TwitterFrontendFlow:
    ...
    def __twitter(self):
        ...
        response = self.session.get(
            "https://twitter.com/", headers=headers, proxies=self.proxies, verify=False
        )
        return self
    ...
    def SaveCookies(self):
        tokens = self.session.cookies.get_dict()
